...
const applicationsByBarangay = [
  { barangay: 'Pacol', applications: 10 },
  { barangay: 'Santa Cruz', applications: 8 },
  { barangay: 'San Rafael', applications: 7 },
  { barangay: 'San Antonio', applications: 6 },
  { barangay: 'Malaking Ilog', applications: 5 }
];

const monthlyApplications = [
  { month: 'January', applications: 7 },
  { month: 'February', applications: 6 },
...
export default function WomenDashboard() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Women Sector Dashboard</h1>
        <p className="text-gray-500 mt-1">Women sector overview and application management</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow">
              ...
              {receivedApplications.map((application) => (
                <tr key={application.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                    <Link to="/sector/women/applications" className="text-blue-600 hover:text-blue-800 font-medium">
                      View
                    </Link>
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
          <p className="text-sm text-gray-600">Showing 5 of 36 applications</p>
          <Link 
            to="/sector/women/applications"

...
const allocationByType = [
  { type: 'Livelihood Programs', amount: 380000, color: '#3B82F6' },
  { type: 'Health & Wellness', amount: 220000, color: '#10B981' },
  { type: 'Skills Training', amount: 140000, color: '#F59E0B' },
  { type: 'Emergency Assistance', amount: 80000, color: '#8B5CF6' },
];

const monthlyDisbursement = [
  { month: 'January', amount: 110000 },
  { month: 'February', amount: 118000 },
  { month: 'March', amount: 135000 },
  { month: 'April', amount: 128000 },
  { month: 'May', amount: 129000 },
];
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Track budget allocation and disbursement for Women assistance</p>
      </div>
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allocationByType.map((item, index) => {
                const disbursed = item.amount * 0.65;

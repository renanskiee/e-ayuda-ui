...
const monthlyDisbursement = [
  { month: 'January', amount: 24000 },
  { month: 'February', amount: 20000 },
  { month: 'March', amount: 30500 },
  { month: 'April', amount: 28000 },
  { month: 'May', amount: 18000 }
];

const assistanceTypeDistribution = [
  { name: 'Livelihood', value: 60000, color: '#3b82f6' },
  { name: 'Medical', value: 36500, color: '#10b981' },
  { name: 'Capital', value: 24000, color: '#f59e0b' }
];

const recentTransactions = [
  { id: "TRX-801", beneficiary: "Angela Flores", barangay: "Pacol", type: "Livelihood Assistance", amount: 4000, date: "Mar 13 2026" },
  { id: "TRX-802", beneficiary: "Diana Ramos", barangay: "Santa Cruz", type: "Medical Assistance", amount: 3000, date: "Mar 11 2026" },
  { id: "TRX-803", beneficiary: "Teresa Mendoza", barangay: "San Rafael", type: "Capital Assistance", amount: 3500, date: "Mar 9 2026" }
];

export default function FundMonitoring() {
  const totalBudget = 180000;
  const totalDisbursed = 120500;
  const remainingBudget = 59500;
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Track and monitor women sector budget allocation and utilization</p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800 mt-2">₱{totalBudget.toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600 mt-2">₱{remainingBudget.toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600 mt-2">{fundsUtilized}%</p>
            </div>
            <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={assistanceTypeDistribution}
                cx="50%"
                cy="50%"
                labelLine={false}
              ...
              >
                {assistanceTypeDistribution.map((entry) => (
                  <Cell key={`assistance-${entry.name}`} fill={entry.color} />
                ))}
              </Pie>
              <Tooltip formatter={(value) => `₱${Number(value).toLocaleString()}`} />
            </PieChart>

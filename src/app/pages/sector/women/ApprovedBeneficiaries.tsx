...
const approvedBeneficiaries = [
  ...
  },
  {
    ...
    barangay: "San Rafael",
    programCategory: "Livelihood Program",
    assistanceReceived: "Capital Assistance",
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Women sector beneficiaries with approved assistance applications</p>
      </div>

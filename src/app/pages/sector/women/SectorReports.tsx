...
const applicationTrends = [
  { month: 'Jan', applications: 7, approved: 6, rejected: 1 },
  { month: 'Feb', applications: 6, approved: 5, rejected: 1 },
  { month: 'Mar', applications: 8, approved: 7, rejected: 1 },
  { month: 'Apr', applications: 7, approved: 6, rejected: 1 },
  { month: 'May', applications: 8, approved: 5, rejected: 3 }
];

const disbursementByType = [
  { type: 'Livelihood', amount: 60000 },
  { type: 'Medical', amount: 36500 },
  { type: 'Capital', amount: 24000 }
];

const reportTemplates = [
  { id: 1, name: "Monthly Women Sector Report", description: "Comprehensive monthly report of sector activities and fund utilization", icon: FileText, color: "blue" },
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Generate and export women sector performance reports</p>
      </div>

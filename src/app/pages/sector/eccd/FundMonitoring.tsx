...
const allocationByType = [
  { type: 'Daycare Support', amount: 280000, color: '#3B82F6' },
  { type: 'Nutrition Programs', amount: 200000, color: '#10B981' },
  { type: 'Early Education', amount: 100000, color: '#F59E0B' },
  { type: 'Health & Immunization', amount: 60000, color: '#8B5CF6' },
];

const monthlyDisbursement = [
  { month: 'January', amount: 88000 },
  { month: 'February', amount: 92000 },
  { month: 'March', amount: 98000 },
  { month: 'April', amount: 95000 },
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Track budget allocation and disbursement for ECCD programs</p>
      </div>
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allocationByType.map((item, index) => {
                const disbursed = item.amount * 0.63;

...
const quarterlyData = [
  { quarter: 'Q1 2026', beneficiaries: 128, disbursed: 232000, applications: 142 },
  { quarter: 'Q2 2026', beneficiaries: 138, disbursed: 238000, applications: 148 }
];

const programTypeData = [
  { type: 'Daycare Support', count: 78, amount: 312000 },
  { type: 'Nutrition Programs', count: 92, amount: 230000 },
  { type: 'Early Education', count: 58, amount: 116000 },
  { type: 'Health & Immunization', count: 38, amount: 76000 }
];

const barangayData = [
  { barangay: 'Pacol', beneficiaries: 55, amount: 125000 },
  { barangay: 'Santa Cruz', beneficiaries: 48, amount: 108000 },
  { barangay: 'San Rafael', beneficiaries: 42, amount: 95000 },
  { barangay: 'Kinalansan', beneficiaries: 38, amount: 86000 },
  { barangay: 'Concepcion Grande', beneficiaries: 35, amount: 78000 },
  { barangay: 'San Antonio', beneficiaries: 32, amount: 72000 },
  { barangay: 'Malaking Ilog', beneficiaries: 34, amount: 75000 }
];

const demographics = {
  totalRegistered: 460,
  activeBeneficiaries: 266,
  age0to2: 88,
  age3to4: 125,
  age5to6: 53,
  maleCount: 138,
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-gray-800">ECCD Sector Reports</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">₱470K</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-blue-600 font-semibold">290 total</span>
          </div>
          <h3 className="text-sm font-medium text-gray-500 mb-1">Applications</h3>
          <p className="text-3xl font-bold text-gray-900">290</p>
          <p className="text-xs text-gray-500 mt-1">92% approval rate</p>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <BarChart3 className="w-8 h-8 text-orange-600" />
            <span className="text-xs text-gray-600 font-semibold">63%</span>
          </div>
          ...
          <p className="text-xs text-gray-500 mt-1">₱280K remaining</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <p className="text-3xl font-bold text-blue-600">{demographics.age0to2}</p>
            <p className="text-sm text-gray-600 mt-1">Age 0-2 years</p>
          </div>
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <p className="text-3xl font-bold text-purple-600">{demographics.age3to4}</p>
            <p className="text-sm text-gray-600 mt-1">Age 3-4 years</p>
          </div>
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <p className="text-3xl font-bold text-green-600">{demographics.age5to6}</p>
            <p className="text-sm text-gray-600 mt-1">Age 5-6 years</p>
          </div>
          ...
          <div className="text-center p-4 bg-cyan-50 rounded-lg">
            <p className="text-3xl font-bold text-cyan-600">{demographics.maleCount}</p>
            <p className="text-sm text-gray-600 mt-1">Male</p>
          </div>
          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <p className="text-3xl font-bold text-orange-600">{demographics.daycareEnrolled}</p>
            <p className="text-sm text-gray-600 mt-1">Daycare Enrolled</p>
          </div>
          <div className="text-center p-4 bg-yellow-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">{demographics.nutritionProgram}</p>
            <p className="text-sm text-gray-600 mt-1">Nutrition Program</p>
          </div>

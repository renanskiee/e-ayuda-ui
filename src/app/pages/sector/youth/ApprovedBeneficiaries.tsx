...
const approvedBeneficiaries = [
  { id: "YC-1001", name: "Mark Dela Cruz", gender: "Male", age: 16, barangay: "Pacol", schoolName: "San Pascual National High School", assistanceReceived: "Educational Assistance", dateApproved: "Mar 12 2026", status: "Active" },
  { id: "YC-1002", name: "Jenny Santos", gender: "Female", age: 14, barangay: "Santa Cruz", schoolName: "San Pascual Elementary School", assistanceReceived: "Scholarship Support", dateApproved: "Mar 10 2026", status: "Active" },
  { id: "YC-1003", name: "Ryan Flores", gender: "Male", age: 17, barangay: "San Rafael", schoolName: "San Pascual National High School", assistanceReceived: "Educational Assistance", dateApproved: "Mar 8 2026", status: "Active" },
  { id: "YC-1004", name: "Maria Garcia", gender: "Female", age: 15, barangay: "San Antonio", schoolName: "San Pascual Elementary School", assistanceReceived: "Scholarship Support", dateApproved: "Mar 5 2026", status: "Active" }
];
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Youth sector beneficiaries with approved assistance applications</p>
      </div>

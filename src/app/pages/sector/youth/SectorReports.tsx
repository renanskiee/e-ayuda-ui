...
const applicationTrends = [
  { month: 'Jan', applications: 6, approved: 5, rejected: 1 },
  { month: 'Feb', applications: 5, approved: 4, rejected: 1 },
  { month: 'Mar', applications: 7, approved: 7, rejected: 0 },
  { month: 'Apr', applications: 6, approved: 5, rejected: 1 },
  { month: 'May', applications: 7, approved: 5, rejected: 2 }
];

const disbursementByType = [
  { type: 'Educational', amount: 68000 },
  { type: 'Scholarship', amount: 28000 },
  { type: 'School Supplies', amount: 14000 }
];

const reportTemplates = [
  { id: 1, name: "Monthly Youth Sector Report", description: "Comprehensive monthly report of sector activities and fund utilization", icon: FileText, color: "blue" },
  { id: 2, name: "Beneficiary Statistics Report", description: "Demographic breakdown and assistance distribution analysis", icon: BarChart3, color: "green" },
  { id: 3, name: "Fund Utilization Report", description: "Detailed budget allocation and disbursement summary", icon: FileText, color: "purple" },
  { id: 4, name: "Application Status Report", description: "Overview of applications received, approved, and rejected", icon: BarChart3, color: "orange" }
];
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Generate and export youth sector performance reports</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="date" className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>
          </div>

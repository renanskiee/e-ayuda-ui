...
const transactions = [
  { id: "TRX-901", beneficiaryName: "Mark Dela Cruz", barangay: "Pacol", assistanceType: "Educational Assistance", amountReleased: 4000, releaseDate: "Mar 13 2026", processedBy: "Youth Sector Staff" },
  { id: "TRX-902", beneficiaryName: "Jenny Santos", barangay: "Santa Cruz", assistanceType: "Scholarship Support", amountReleased: 3000, releaseDate: "Mar 11 2026", processedBy: "Youth Sector Staff" },
  { id: "TRX-903", beneficiaryName: "Ryan Flores", barangay: "San Rafael", assistanceType: "Educational Assistance", amountReleased: 3500, releaseDate: "Mar 9 2026", processedBy: "Youth Sector Staff" },
  { id: "TRX-904", beneficiaryName: "Maria Garcia", barangay: "San Antonio", assistanceType: "Scholarship Support", amountReleased: 3000, releaseDate: "Mar 7 2026", processedBy: "Youth Sector Staff" },
  { id: "TRX-905", beneficiaryName: "Carlos Reyes", barangay: "Malaking Ilog", assistanceType: "Educational Assistance", amountReleased: 4000, releaseDate: "Mar 5 2026", processedBy: "Youth Sector Staff" },
  { id: "TRX-906", beneficiaryName: "Lisa Aquino", barangay: "Pacol", assistanceType: "School Supplies", amountReleased: 2000, releaseDate: "Mar 3 2026", processedBy: "Youth Sector Staff" }
];
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-lg shadow p-6 mb-6 text-white">
        <div className="flex items-center justify-between">
          <div><p className="text-purple-100 text-sm">Total Transactions</p><p className="text-3xl font-bold mt-1">{transactions.length}</p></div>
          <div className="text-right"><p className="text-purple-100 text-sm">Total Amount Disbursed</p><p className="text-3xl font-bold mt-1">₱{totalAmount.toLocaleString()}</p></div>
        </div>
      </div>

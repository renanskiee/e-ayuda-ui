...
export default function EvaluationQueue() {
  ...
  useEffect(() => {
    const loadApplications = async () => {
      // Get applications for Youth sector with status Received or Under Evaluation
  ...
  const handleSubmitEvaluation = async () => {
    ...
    const currentUser = localStorage.getItem('username') || 'sector-youth-001';
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Evaluation Queue - Youth</h1>
        <p className="text-gray-500 mt-1">Review and evaluate pending youth applications</p>
      </div>

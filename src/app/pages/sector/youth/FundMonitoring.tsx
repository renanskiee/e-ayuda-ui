...
const allocationByType = [
  { type: 'Educational Assistance', amount: 320000, color: '#3B82F6' },
  { type: 'Skills Development', amount: 210000, color: '#10B981' },
  { type: 'Sports Programs', amount: 120000, color: '#F59E0B' },
  { type: 'Scholarship Support', amount: 70000, color: '#8B5CF6' },
];

const monthlyDisbursement = [
  { month: 'January', amount: 98000 },
  { month: 'February', amount: 105000 },
  { month: 'March', amount: 118000 },
  { month: 'April', amount: 112000 },
  { month: 'May', amount: 107000 },
];
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Track budget allocation and disbursement for Youth programs</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        {/* Allocation by Type */}
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Budget Allocation by Program Type</h3>
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allocationByType.map((item, index) => {
                const disbursed = item.amount * 0.64;

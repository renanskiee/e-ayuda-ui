...
const applicationsByBarangay = [
  { barangay: 'Pacol', applications: 18 },
  { barangay: 'Santa Cruz', applications: 14 },
  { barangay: 'San Rafael', applications: 12 },
  { barangay: 'San Antonio', applications: 9 },
  { barangay: 'Malaking Ilog', applications: 7 }
];

const monthlyApplications = [
  { month: 'January', applications: 12 },
  { month: 'February', applications: 10 },
  { month: 'March', applications: 14 },
  { month: 'April', applications: 16 },
  { month: 'May', applications: 13 }
];

export default function SeniorCitizenDashboard() {
  const fundsUtilized = 72;
  const totalBudget = 300000;
  const totalDisbursed = 214500;
  const remainingBudget = 85500;

  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Senior Citizen Dashboard</h1>
        <p className="text-gray-500 mt-1">Sector overview and application management</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <Link 
            to="/sector/senior-citizen/funds"
      ...
      <div className="bg-white rounded-lg shadow">
              ...
              {receivedApplications.map((application) => (
                <tr key={application.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                    <Link to="/sector/senior-citizen/applications" className="text-blue-600 hover:text-blue-800 font-medium">
                      View
                    </Link>
                    <Link to="/sector/senior-citizen/evaluation" className="text-green-600 hover:text-green-800 font-medium">
                      Evaluate
                    </Link>
                  </td>
                </tr>
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
          <p className="text-sm text-gray-600">Showing 5 of 65 applications</p>
          <Link 
            to="/sector/senior-citizen/applications"

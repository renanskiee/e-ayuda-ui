...
export default function EvaluationQueue() {
  ...
  const queuedApplications = seniorCitizenApplications.filter(app => 
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-gray-900">{selectedApplication.age}</span>
                  </div>
                  <div>
                    <span className="text-gray-500">Medical Condition:</span>
                    <span className="ml-2 text-gray-900">{selectedApplication.medicalCondition}</span>
                  </div>
                  <div>

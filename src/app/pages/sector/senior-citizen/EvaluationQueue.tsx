...
export default function EvaluationQueue() {
  ...
  useEffect(() => {
    const loadApplications = () => {
      // Get applications for Senior Citizen sector with status Received or Under Evaluation
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Evaluation Queue - Senior Citizen</h1>
        <p className="text-gray-500 mt-1">Review and evaluate pending senior citizen applications</p>
      </div>

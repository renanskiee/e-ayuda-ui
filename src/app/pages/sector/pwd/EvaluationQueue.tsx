...
export default function EvaluationQueue() {
  ...
  useEffect(() => {
    const loadApplications = () => {
      // Get applications for PWD sector with status Received or Under Evaluation
  ...
  const handleSubmitEvaluation = () => {
    ...
    const currentUser = localStorage.getItem('username') || 'sector-pwd-001';
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Evaluation Queue - PWD</h1>
        <p className="text-gray-500 mt-1">Review and evaluate pending pwd applications</p>
      </div>

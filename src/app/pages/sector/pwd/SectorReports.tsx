...
const quarterlyData = [
  { quarter: 'Q1 2026', beneficiaries: 285, disbursed: 630000, applications: 320 },
  { quarter: 'Q2 2026', beneficiaries: 265, disbursed: 650000, applications: 295 }
];

const assistanceTypeData = [
  { type: 'Assistive Devices', count: 142, amount: 580000 },
  { type: 'Medical Assistance', count: 98, amount: 320000 },
  { type: 'Therapy Support', count: 87, amount: 215000 },
  { type: 'Livelihood Aid', count: 65, amount: 165000 }
];

const barangayData = [
  { barangay: 'Pacol', beneficiaries: 115, amount: 285000 },
  { barangay: 'Santa Cruz', beneficiaries: 92, amount: 240000 },
  { barangay: 'San Rafael', beneficiaries: 88, amount: 225000 },
  { barangay: 'Kinalansan', beneficiaries: 76, amount: 195000 },
  { barangay: 'Concepcion Grande', beneficiaries: 68, amount: 180000 },
  { barangay: 'San Antonio', beneficiaries: 52, amount: 135000 },
  { barangay: 'Malaking Ilog', beneficiaries: 59, amount: 160000 }
];

const demographics = {
  totalRegistered: 850,
  activeBeneficiaries: 550,
  maleCount: 295,
  femaleCount: 255,
  visualImpairment: 125,
  hearingImpairment: 98,
  mobilityImpairment: 185,
  intellectualDisability: 72,
  psychosocialDisability: 70,
  indigent: 325,
  employed: 145
};
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-gray-800">PWD Sector Reports</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">₱1.28M</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-blue-600 font-semibold">615 total</span>
          </div>
          <h3 className="text-sm font-medium text-gray-500 mb-1">Applications</h3>
          <p className="text-3xl font-bold text-gray-900">615</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-gray-600 font-semibold">71%</span>
          </div>
          ...
          <p className="text-xs text-gray-500 mt-1">₱520K remaining</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <p className="text-3xl font-bold text-green-600">{demographics.indigent}</p>
            <p className="text-sm text-gray-600 mt-1">Indigent</p>
          </div>
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <p className="text-3xl font-bold text-purple-600">{demographics.employed}</p>
            <p className="text-sm text-gray-600 mt-1">Employed</p>
          </div>
          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <p className="text-3xl font-bold text-orange-600">{demographics.visualImpairment}</p>
            <p className="text-sm text-gray-600 mt-1">Visual Impairment</p>
          </div>
          <div className="text-center p-4 bg-yellow-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">{demographics.hearingImpairment}</p>
            <p className="text-sm text-gray-600 mt-1">Hearing Impairment</p>
          </div>
          <div className="text-center p-4 bg-red-50 rounded-lg">
            <p className="text-3xl font-bold text-red-600">{demographics.mobilityImpairment}</p>
            <p className="text-sm text-gray-600 mt-1">Mobility Impairment</p>
          </div>
          <div className="text-center p-4 bg-indigo-50 rounded-lg">
            <p className="text-3xl font-bold text-indigo-600">{demographics.intellectualDisability}</p>
            <p className="text-sm text-gray-600 mt-1">Intellectual Disability</p>
          </div>
        </div>
      </div>
    </div>

...
const allocationByType = [
  { type: 'Assistive Devices', amount: 120000, color: '#3B82F6' },
  { type: 'Mobility Aids', amount: 95000, color: '#10B981' },
  { type: 'Medical Support', amount: 80000, color: '#F59E0B' },
  { type: 'Therapy Services', amount: 55000, color: '#8B5CF6' },
];

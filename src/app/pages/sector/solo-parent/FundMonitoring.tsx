...
const allocationByType = [
  { type: 'Educational Assistance', amount: 450000, color: '#3B82F6' },
  { type: 'Livelihood Support', amount: 280000, color: '#10B981' },
  { type: 'Financial Assistance', amount: 180000, color: '#F59E0B' },
  { type: 'Medical Assistance', amount: 140000, color: '#8B5CF6' },
];

const monthlyDisbursement = [
  { month: 'January', amount: 145000 },
  { month: 'February', amount: 162000 },
  { month: 'March', amount: 178000 },
  { month: 'April', amount: 168000 },
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Track budget allocation and disbursement for Solo Parent assistance</p>
      </div>
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allocationByType.map((item, index) => {
                const disbursed = item.amount * 0.68;

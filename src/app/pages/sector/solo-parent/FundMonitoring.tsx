...
const monthlyDisbursement = [
  { month: 'January', amount: 28000 },
  { month: 'February', amount: 32000 },
  { month: 'March', amount: 35500 },
  { month: 'April', amount: 26000 },
  { month: 'May', amount: 13000 }
];

const assistanceTypeDistribution = [
  { name: 'Educational', value: 68000, color: '#3b82f6' },
  { name: 'Financial', value: 42500, color: '#10b981' },
  { name: 'Medical', value: 24000, color: '#f59e0b' }
];

const recentTransactions = [
  {
    id: "TRX-701",
    beneficiary: "Ana Ramirez",
    barangay: "Pacol",
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Track and monitor solo parent sector budget allocation and utilization</p>
      </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-medium text-gray-700">
              ₱{totalDisbursed.toLocaleString()} of ₱{totalBudget.toLocaleString()}
            </p>
            ...
            <PieChart>
              ...
              >
                {assistanceTypeDistribution.map((entry) => (
                  <Cell key={`sp-assistance-${entry.name}`} fill={entry.color} />
                ))}
              </Pie>
              <Tooltip formatter={(value) => `₱${Number(value).toLocaleString()}`} />
            </PieChart>

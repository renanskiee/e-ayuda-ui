...
const queuedApplications = [
  {
    ...
    age: 35,
    gender: "Female",
    address: "456 Main St., Pacol",
    barangay: "Pacol",
    contactNumber: "0917-234-5678",
    soloParentId: "SP-2024-001234",
    numberOfChildren: 2,
    employmentStatus: "Self-Employed",
    assistanceType: "Educational Assistance",
    requestedAmount: "₱4,000",
    reason: "School supplies and tuition fees for two children"
  }
];
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Review and evaluate pending solo parent sector applications</p>
      </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 border-b pb-2 mt-6">Solo Parent Details</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Solo Parent ID Number</label>
                    <p className="text-gray-900">{selectedApplication.soloParentId}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Number of Children</label>
                    <p className="text-gray-900">{selectedApplication.numberOfChildren}</p>
                  </div>
                  <div className="col-span-2">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
                    <FileText className="w-5 h-5 text-blue-600" />
                    <span className="text-sm text-gray-700">Solo Parent ID</span>
                    <button className="ml-auto text-sm text-blue-600 hover:underline">View</button>
                  </div>
                  <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
                    <FileText className="w-5 h-5 text-blue-600" />

...
const quarterlyData = [
  { quarter: 'Q1 2026', beneficiaries: 195, disbursed: 380000, applications: 215 },
  { quarter: 'Q2 2026', beneficiaries: 205, disbursed: 440000, applications: 230 }
];

const assistanceTypeData = [
  { type: 'Educational', count: 108, amount: 432000 },
  { type: 'Livelihood Support', count: 72, amount: 432000 },
  { type: 'Financial', count: 95, amount: 332500 },
  { type: 'Medical', count: 125, amount: 312500 }
];

const barangayData = [
  { barangay: 'Pacol', beneficiaries: 85, amount: 195000 },
  { barangay: 'Santa Cruz', beneficiaries: 72, amount: 168000 },
  { barangay: 'San Rafael', beneficiaries: 68, amount: 152000 },
  { barangay: 'Kinalansan', beneficiaries: 58, amount: 132000 },
  { barangay: 'Concepcion Grande', beneficiaries: 52, amount: 118000 },
  { barangay: 'San Antonio', beneficiaries: 45, amount: 98000 },
  { barangay: 'Malaking Ilog', beneficiaries: 48, amount: 105000 }
];

const demographics = {
  totalRegistered: 680,
  activeBeneficiaries: 400,
  femaleCount: 365,
  maleCount: 35,
  withChildren0to5: 185,
  withChildren6to12: 210,
  withChildren13to18: 150,
  employed: 225,
  unemployed: 175,
  indigent: 245
};
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-gray-800">Solo Parent Sector Reports</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">₱820K</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-blue-600 font-semibold">445 total</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">₱380K remaining</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <p className="text-3xl font-bold text-green-600">{demographics.employed}</p>
            <p className="text-sm text-gray-600 mt-1">Employed</p>
          </div>
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <p className="text-3xl font-bold text-purple-600">{demographics.unemployed}</p>
            <p className="text-sm text-gray-600 mt-1">Unemployed</p>
          </div>
          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <p className="text-3xl font-bold text-orange-600">{demographics.withChildren0to5}</p>
            <p className="text-sm text-gray-600 mt-1">Children 0-5</p>
          </div>
          <div className="text-center p-4 bg-yellow-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">{demographics.withChildren6to12}</p>
            <p className="text-sm text-gray-600 mt-1">Children 6-12</p>
          </div>
          <div className="text-center p-4 bg-red-50 rounded-lg">
            <p className="text-3xl font-bold text-red-600">{demographics.withChildren13to18}</p>
            <p className="text-sm text-gray-600 mt-1">Children 13-18</p>
          </div>

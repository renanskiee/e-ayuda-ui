...
const transactions = [
  {
    ...
    processedBy: "Solo Parent Sector Staff"
  },
  {
    id: "TRX-702",
    beneficiaryName: "Grace Villanueva",
    barangay: "Santa Cruz",
